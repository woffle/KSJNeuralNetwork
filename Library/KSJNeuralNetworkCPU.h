...
@interface KSJNeuralNetworkCPU : KSJNeuralNetwork <KSJNeuralNetworkProtocol>

/*! @brief Creates a CPU accelerated Fully Connected Layer based on the specifications provided in the FCAC (Fully Connected Architecture Configuration)
...
/*! @brief Creates a CPU accelerated Convolution Layer based on the specifications provided in the CAC (Convolution Architecture Configuration)
...
/*! @brief Creates a CPU accelerated Average or Max Pooling Layer based on the specifications provided in the PAC (Pooling Architecture Configuration)
